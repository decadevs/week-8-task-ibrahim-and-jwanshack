...
import com.olamachia.maptrackerweekeighttask.adapter.PokemonDetailsAdapter
...
import com.olamachia.maptrackerweekeighttask.utils.Utils
    ...
    private fun getDetails(receivedName: String) {
        ...
        compositeDisposable.add(getPokeApi.getPokemonDetails(receivedName)
            ...
            .subscribe { pokemonDetails ->
                ...
                recyclerViewMoves.layoutManager = LinearLayoutManager(activity,
                    LinearLayoutManager.HORIZONTAL,false)
                ...
                recyclerViewStats.layoutManager = LinearLayoutManager(activity,
                    LinearLayoutManager.HORIZONTAL,false)
